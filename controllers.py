...
def ctrl_selector(
    ...
    if mode == "manual":
        ...
        action = ctrl_benchmarking.compute_action(
            t, observation, constraints, line_constraints, circ_constraints
        )
...
class CtrlRLStab:
    ...
    def _actor(self, observation, w_actor):
        ...
        return (
            reshape(w_actor, (self.dim_input, self.dim_actor_per_input))
            @ regressor_actor
        )
    ...
    def _critic(self, observation, w_critic, lmbd):
        ...
        return lmbd * w_critic @ regressor_critic + (
            1 - lmbd
    ...
    def _actor_critic_cost(self, w_all):
        ...
        for k in range(self.Ncritic - 1, 0, -1):
            ...
            e = (
                ...
                - self.stage_obj(observation_prev, action)
            )
    ...
    def _actor_critic_optimizer(self, observation):
        ...
        self.w_actor_init = self._w_actor_from_action(
            self.safe_ctrl.compute_action_vanila(observation), observation
        )
...
class CtrlOptPred:
    ...
    def _actor_optimizer(
        self, observation, constraints=[], line_constraints=None, circ_constraints=None
    ):
        """
    ...
    def compute_action(
        self, t, observation, constraints=None, line_constrs=None, circ_constrs=None
    ):
        """
            ...
            if self.mode == "MPC":
                ...
                if self.is_prob_noise and self.is_est_model:
                    ...
                    action = self._actor_optimizer(
                        observation, constraints, line_constrs, circ_constrs
                    )
