...
if __name__ == "__main__":
    ...
    parser.add_argument('--is_casadi', type=bool,
                    default=True,
                    help='Whether casadi optimization framework is used for actor cost optimization')
    ...
    my_ctrl_opt_pred = controllers.CtrlOptPred(dim_input,
                                            ...
                                            stage_obj_pars = [R1],
                                            observation_target = [],
                                            is_casadi = args.is_casadi,
                                            pars = [10, 1],
                                            pars_disturb=np.array([[20*dt, 20*dt], [0, 0], [0.2, 0.2]])
                                            )
    ...
    ros_preset_task = ROS_preset(ctrl_mode, [0, 0, 0], state_goal, my_ctrl_nominal, my_sys, my_ctrl_benchm, my_logger, datafiles, args.is_casadi)
