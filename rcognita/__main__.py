...
def main(args=None):
    ...
    if args is not None:
        ...
        # environment
        sys1 = System(num_controllers=1)
        controller1 = Controller(sys1,
                           sample_time=0.3,
                           pred_step_size=2,
                            critic_mode=3,
                            ctrl_mode=3,
    ...
    # sim = Simulation(sys1, [controller1, controller2], [nominal_ctrl1,nominal_ctrl2], t1=30)
    sim.run_simulation()
