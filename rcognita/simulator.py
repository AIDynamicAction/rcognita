...
from rcognita.utilities import rej_sampling_rvs
...
class simulator:
    ...
    def __init__(self, sys_type, closed_loop_rhs, sys_out, x0, q0=[], u0=[], t0=0, t1=1, dt=1e-2, max_step=0.5e-2, first_step=1e-6, atol=1e-5, rtol=1e-3, is_dyn_ctrl=0):
